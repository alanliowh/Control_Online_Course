...
%% constant TORQUE with Gain-Scheduling
controller.KK1 = 0; % deg
controller.KK2 = 0; % deg^2
...
%% constant POWER with Gain-Scheduling
controller.Kp3 = 0;
controller.Ki3 = 0;
...
figure(1); legend('no GS','Const Torq','Const Pow');
figure(2); legend('no GS','Const Torq','Const Pow');
