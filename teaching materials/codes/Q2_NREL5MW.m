...
controller.Kp25 = 0.193e8  ;
controller.Ki25 = 0.43e7 ; 
controller.Kp3 = 0.923; % rad/(rad/s)
controller.Ki3 =0.248 ; % rad/(rad)
controller.KK1 = 11.32; % deg
controller.KK2 = 524.536; % deg^2
